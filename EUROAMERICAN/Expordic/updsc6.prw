...
/*/
//--------------------------------------------------------------------
User Function UPD_SC6( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSC6" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDSC6" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
PutSX1Help( "PC6_XPESBUT", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "C6_XPESBUT" )

aHlpPor := {}
aAdd( aHlpPor, 'Calculo Peso Liquido' )

PutSX1Help( "PC6_XPESLIQ", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "C6_XPESLIQ" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDSC6" ) ) ) ;
