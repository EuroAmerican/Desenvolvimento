...
/*/
//--------------------------------------------------------------------
User Function UPDUNEEC( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDUNEEC" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDUNEEC" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aHlpPor := {}
aAdd( aHlpPor, 'Informa o orçamento de origem do PV.' )

PutSX1Help( "PEE7_XNUMOR", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "EE7_XNUMOR" )
...
aHlpPor := {}
aAdd( aHlpPor, 'Calculo Qtde de Expedição' )

PutSX1Help( "EE8_XCLEXP ", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "EE8_XCLEXP" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDUNEEC" ) ) ) ;
