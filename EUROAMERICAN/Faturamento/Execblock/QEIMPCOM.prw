...
Define MsDialog oDlg1 From 000,000  TO 015,060 Title OemToAnsi("Atualiza Percentual de Comissão - QUALY") 
@ 003,005 TO 090,230
...
Static Function QESB101ok()
	...
	oExcel:AddColumn(cNomPla, cTitPla, "Descrição Produto"        , 1, 1, .F.)     //04
	oExcel:AddColumn(cNomPla, cTitPla, "tipo"                     , 1, 1, .F.)     //05
	oExcel:AddColumn(cNomPla, cTitPla, "Grupo"                    , 1, 1, .F.)     //06
	oExcel:AddColumn(cNomPla, cTitPla, "Descrição Grupo"          , 1, 1, .F.)     //07
	oExcel:AddColumn(cNomPla, cTitPla, "Descrição Linha"          , 1, 1, .F.)     //08
	oExcel:AddColumn(cNomPla, cTitPla, "Data Vig. Inicial"        , 1, 1, .F.)     //09
	oExcel:AddColumn(cNomPla, cTitPla, "Data Vig. Final"          , 1, 1, .F.)     //10
	oExcel:AddColumn(cNomPla, cTitPla, "Comissão 1"               , 3, 2, .F.)     //11
