...
Private cCodUsr  := ''
	...
	If SA3->(dbSeek(xFILIAL("SA3")+MV_PAR04))
		cCodUsr := SA3->A3_COD
	Else
		MSGINFO("A T E N Ç Ã O" + CRLF + CRLF + "Entrar em contato com o departamento comercial para informar no (seu cadastro de vendedor) o codigo do usuário." + CRLF + CRLF + "Codigo do usuário: (" + MV_PAR05 + ")")
		Return
	EndIf
