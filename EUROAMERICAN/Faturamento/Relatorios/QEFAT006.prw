...
Static Function QEFAT06ok()
    ...
    cQuery := "SELECT C9_FILIAL,A1_EST,C9_PEDIDO,C9_CLIENTE,C9_LOJA,C9_QTDLIB, C9_ORDSEP, A1_COD, A1_LOJA, A1_NOME, C5_VEND1, "+CRLF
	...
	oExcel:AddColumn(cNomPla, cTitPla, "Qtd. PV"           , 3, 2, .F.)  //13
	oExcel:AddColumn(cNomPla, cTitPla, "Qtd. LIb."         , 3, 2, .F.)  //14
	oExcel:AddColumn(cNomPla, cTitPla, "Vl. Total PV"      , 3, 2, .F.)  //15
	oExcel:AddColumn(cNomPla, cTitPla, "Peso Bruto PV"     , 3, 2, .F.)  //16
	oExcel:AddColumn(cNomPla, cTitPla, "Peso Atend."       , 3, 2, .F.)  //17
	oExcel:AddColumn(cNomPla, cTitPla, "Vl. Atend."        , 3, 2, .F.)  //18
	oExcel:AddColumn(cNomPla, cTitPla, "% Atend. VL"       , 3, 2, .F.)  //19
	oExcel:AddColumn(cNomPla, cTitPla, "% Atend. Peso"     , 3, 2, .F.)  //20
