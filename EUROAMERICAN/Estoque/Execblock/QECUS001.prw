...
#Define ALIAS_FORM0 			"PAZ" //Informe o Alias da Tabela
#Define MODELO					"QECUS001"
#Define ID_MODEL				"QECUSM01"
#Define TITULO_MODEL			"Tabela Confêrencia Custo Net" 
...
/*/{Protheus.doc} QECUS001 - Analise calculo de custo net
Fonte Modelo de MVC - Interface Modelo 1 para Analise custo net
@type function
...
/*/ 
User Function QECUS001(aAutoCab,nOperacao)
	...
	Else	
		...
		oFwMBrowse:AddLegend( cAliasForm+"_STATUS == '1'  ", "BR_VERDE"     , "Custo Test" )
		oFwMBrowse:AddLegend( cAliasForm+"_STATUS == '2'  ", "BR_AZUL"      , "Custo Stardart" )
...
Static Function ModelDef()
	...
	Local cCpoCodigo		:= cPrefForm+"_ORDEM"
	Local cCpoProduto		:= cPrefForm+"_COD"
	Local cCpoComp		    := cPrefForm+"_COMP"
	Local cCpoCodPI		    := cPrefForm+"_CODPI"
	
	//PAZ_FILIAL+PAZ_ORDEM+PAZ_COD+PAZ_COMP+PAZ_CODPI                                                                                                                 
	...
	oModel:SetPrimaryKey( { cCpoFilial, cCpoCodigo,cCpoProduto,cCpoComp,cCpoCodPI } )
