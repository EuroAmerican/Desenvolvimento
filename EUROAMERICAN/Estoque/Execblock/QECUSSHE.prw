...
cQuery1 += "INNER JOIN "+RetSqlName("SG1")+" AS SG1 ON G1_FILIAL = '0803' " + CRLF
...
cQuery1 += " AND G1_FILIAL = '0803' " + CRLF
...
If cFilant $ "0803" 
	...
	If _lGravou 
		...
		_cTexto += '<b><font size="3" face="Arial">Foi Atualizado Custo Net/Test pelo Scheduler!!!</font></b><br><br>'
		_cTexto += '<b><font size="2" face="Arial" Color="Red">Observação: Deve ser realizado a confêrencia do Custo Net na Empresa/Filial '+AllTrim(SM0->M0_FILIAL)+'</font></b><br>'
		_cTexto += '<br><br><b><font size="3" face="Arial" color="Blue">'+AllTrim(SM0->M0_NOME)+' - '+AllTrim(SM0->M0_FILIAL)+'</font></b><br>'
		_cTexto += '</html>'

		_cDest := GetMV("QE_MAILSHE")
			
		If !Empty(_cDest).And.Len(_cTexto)>30
			U_EQMAIL08(_cDest,"","Foi Executado a Atualização de Custo Net/Test pela Rotina de Scheduler!!! ",_cTexto,"",.T.)
		EndIf
...
User Function EQMAIL08(cRecebe,cCopia,cAssunto,cMensagem,cFile,lDisplay)
