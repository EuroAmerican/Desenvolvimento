...
//@ C(035),C(215) SAY OemtoAnsi("QualyCril") OBJECT oMsg1 Size C(100),C(012) COLOR CLR_GREEN FONT oFont PIXEL OF _oDlg 
//@ C(035),C(215) SAY OemtoAnsi("QualyCril") OBJECT oMsg2 Size C(100),C(012) COLOR CLR_BLUE  FONT oFont PIXEL OF _oDlg 
oSay1 := TSay():New(C(035),C(210),{|| OemtoAnsi("QualyCril") },_oDlg,,oFont,,,,.t.,CLR_GREEN,,100,12)
oSay2 := TSay():New(C(035),C(210),{|| OemtoAnsi("QualyCril") },_oDlg,,oFont,,,,.t.,CLR_RED,,100,12)
